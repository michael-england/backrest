                ...
                if (server.settings.collections[collection]) {
                    ...
                    if (json.jsonrpc === "2.0") {
                        ...
                        if (collection == server.settings.authentication.collection && authenticationMethods.indexOf(json.method) > -1) {
                            ...
                            this[json.method](server, request, response, json);
                        } else {
                            next();
                        }
                    } else {
...
module.exports.login = function(server, request, response, json) {
...
module.exports.logout = function(server, request, response, json) {
...
module.exports.changePassword = function(server, request, response, json) {
    ...
    if (request.session.user) {
        ...
        // user currently not logged in
        server.error(request, response, -32000, "User not logged in.", json.id, undefined);
        return;
    }
};

module.exports.passwordResetRequest = function(server, request, response, json) {
...
module.exports.passwordReset = function(server, request, response, json) {
...
module.exports.confirmEmailRequest = function(server, request, response, json) {
...
module.exports.confirmEmail = function(server, request, response, json) {
...
module.exports.isInRole = function(server, request, response, json) {
...
module.exports.isAuthenticated = function(server, request, response, json) {
