...
module.exports = function(server, callback) {
  ...
  module.exports.createAdminAccount(function(error, user) {
    ...
    if (!user) {
      console.log('Failed to create user. Restart MongoConductor to create an admin account.');
      return;
    }
    ...
    fs.writeFileSync('./settings.json', JSON.stringify(server.settings, null, '\t'));
...
module.exports.createAdminAccount = function(callback) {
  try {
