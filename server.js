...
MongoRpc = function () {
        	            ...
        	            if (allowed) {
        	                ...
        	                if (method[index] !== "save" && method[index] !== "findOne" && method[index] !== "update" && method[index] !== "findAndModify" && method[index] !== "group" && method[index] !== "mapReduce") {
        	                    ...
        	                    validators.validate(this, request, collection, method[index], action, json, json.params[index], function (validationSummary) {
        	                        ...
        	                        // emit validate event
        	                        this.emit(collection + "_" + method[index] + "_" + action + "_validate", { "currentTarget": this, "request": request, "params": json.params[index]});
        	                        ...
        	                        if (validationSummary == true) {
        	                            ...
        	                            // emit filtered event
        	                            this.emit(collection + "_" + method[index] + "_" + action + "_filter", { "direction": "in", "currentTarget": this, "request": request, "params": json.params[index]});
    ...
    this.processUpload = function (request, response, collection, field, step, _id, origin, temp) {
        ...
        // respond to request with error
        response.writeHead(302, {"Location": "/upload.html?collection=" + collection 
            + "&field=" + field 
            + "&step=" + step 
            + "&_id=" + _id 
            + "&origin=" + origin 
